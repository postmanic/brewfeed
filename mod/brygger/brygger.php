...
if  ($userid > 0)
{
    ...
    while (($definition = $result_beer->fetch_assoc()) != NULL)
       ...
       $brygliste .= "<td>".$definition['og']."</td>";
       $brygliste .= "<td>".$definition['fg']."</td>";
       $brygliste .= "<td>".$definition['alk']."</td>";       
       $brygliste .= "<td>".$definition['ibu']."</td>";
       $brygliste .= "<td>".$definition['ebc']."</td>";
       $brygliste .= "<td>".$definition['brygget']."</div></td>"; 
...
<table width="100%">
  <tr>
    <td>
      <div id="container" style="min-width: 350px; max-width: 350px; height: 250px; margin: 0 auto"></div>
    </td>
  </tr>
</table>
...
<tr><td><a href='index.php?page=crbrfo.php'>Opret bryg</a></td>
